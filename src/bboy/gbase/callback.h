...
#ifndef BBOY_GBASE_CALLBACK_H_
#define BBOY_GBASE_CALLBACK_H_
...
// Closure should #include "bboy/gbase/callback_forward.h" instead of this file.
...
//
// A callback with no unbound input parameters (bb::Callback<void(void)>)
// is called a bb::Closure. Note that this is NOT the same as what other
...
//   bb::Callback<int(void)> func_cb = bb::Bind(&Return5);
...
//
//   class Ref : public bb::RefCountedThreadSafe<Ref> {
//    public:
//     int Foo() { return 3; }
//     void PrintBye() { LOG(INFO) << "bye."; }
//   };
//   scoped_refptr<Ref> ref = new Ref();
//   bb::Callback<void(void)> ref_cb = bb::Bind(&Ref::Foo, ref);
...
//
//   void DoSomething(const bb::Callback<void(int, std::string)>& callback) {
//     callback.Run(5, "hello");
//   }
//
//   Callbacks can be run more than once (they don't get deleted or marked when
//   run). However, this precludes using bb::Passed (see below).
//
//   void DoSomething(const bb::Callback<double(double)>& callback) {
...
//   bb::Callback<void(int, const std::string&)> cb = bb::Bind(&MyFunc);
...
//
//   void MyFunc(int i, const std::string& str) {}
//   bb::Callback<void(void)> cb = bb::Bind(&MyFunc, 23, "hello world");
//   cb.Run();
//
//   A callback with no unbound input parameters (bb::Callback<void(void)>)
//   is called a bb::Closure. So we could have also written:
//
//   bb::Closure cb = bb::Bind(&MyFunc, 23, "hello world");
//
//   When calling member functions, bound parameters just go after the object
//   pointer.
//
//   bb::Closure cb = bb::Bind(&MyClass::MyFunc, this, 23, "hello world");
//
...
//
//   void MyFunc(int i, const std::string& str) {}
//   bb::Callback<void(const std::string&)> cb = bb::Bind(&MyFunc, 23);
//   cb.Run("hello world");
//
...
//
//   bb::Bind(&MyClass::Foo, GetWeakPtr());
//
...
//
//   bb::Bind(&MyClass::Foo, bb::Unretained(this));
//
...
//   bb::Bind(&MyClass::Foo, bb::Owned(myclass));
//
...
//   bb::Callback<void<int>) cb =
//       bb::Bind(bb::IgnoreResult(&DoSomething));
//
//
// -----------------------------------------------------------------------------
...
// Closure (bb::Callback<void(void)> and bb::Closure are the same thing).
//
// PASSING PARAMETERS OWNED BY THE CALLBACK
//
//   void Foo(int* arg) { cout << *arg << endl; }
//   int* pn = new int(1);
//   bb::Closure foo_callback = bb::Bind(&foo, bb::Owned(pn));
//
...
//   bb::Closure cb = bb::Bind(&TakesOwnership, bb::Passed(&f));
//
...
//   bb::Closure cb = bb::Bind(&TakesOneRef, f);
//
...
//   void foo(int arg) { cout << arg << endl }
//   int n = 1;
//   bb::Closure has_ref = bb::Bind(&foo, bb::ConstRef(n));
//   n = 2;
...
// file-level comment in bboy/gbase/bind_helpers.h for more info.
//
