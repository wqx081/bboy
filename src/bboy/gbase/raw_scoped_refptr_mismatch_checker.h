...
#ifndef BBOY_GBASE_RAW_SCOPED_REFPTR_MISMATCH_CHECKER_H_
#define BBOY_GBASE_RAW_SCOPED_REFPTR_MISMATCH_CHECKER_H_
...
#endif  // BBOY_GBASE_RAW_SCOPED_REFPTR_MISMATCH_CHECKER_H_
