...
#ifndef BBOY_GBASE_GSCOPED_PTR_H_
#define BBOY_GBASE_GSCOPED_PTR_H_
...
#include "bboy/gbase/template_util.h"
#include "bboy/gbase/type_traits.h"
#include "bboy/gbase/move.h"
...
//
// gscoped_ptr<int, bb::FreeDeleter> foo_ptr(
...
template <typename T> struct IsNotRefCounted {
  enum {
    value = !base::is_convertible<T*, bb::subtle::RefCountedBase*>::value &&
        !base::is_convertible<T*, bb::subtle::RefCountedThreadSafeBase*>::
            value
  };
};
...
// types.
template <class T, class D = bb::DefaultDeleter<T> >
class gscoped_ptr {
  MOVE_ONLY_TYPE_FOR_CPP_03(gscoped_ptr, RValue)

  COMPILE_ASSERT(bb::internal::IsNotRefCounted<T>::value,
 ...
 private:
  typedef bb::internal::gscoped_ptr_impl<element_type, deleter_type>
 ...
 private:
  ...
  bb::internal::gscoped_ptr_impl<element_type, deleter_type> impl_;
...
// DEPRECATED: Use gscoped_ptr<C, bb::FreeDeleter> instead.
//
// gscoped_ptr_malloc<> is similar to gscoped_ptr<>, but it accepts a
// second template argument, the functor used to free the object.

template<class C, class FreeProc = bb::FreeDeleter>
...
#endif  // BBOY_GBASE_GSCOPED_PTR_H_
